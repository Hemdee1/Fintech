...
const Hero = () => {
  return (
    <section className="w-fullscreen mx-auto max-w-full px-4 sm:px-16 xl:px-[136px] pb-[60px] sm:pb-[141px] h-[723px] flex items-end relative">
      ...
      <div className="w-[675px] flex flex-col items-start gap-6 z-10">
        <h1
          className="text-[32px] sm:text-[64px] font-bold leading-[43px] sm:leading-[86px] bg-gradient-to-r from-[#D9DCF1] to-[#d9dcf11c] bg-clip-text text-transparent inline-block"
          data-aos="fade-up"
        >
          Revolutionize the way you save and grow your wealth
        </h1>
        <h3 className="text-secondary text-sm sm:text-base" data-aos="fade-up">
        ...
        <button className="btn relative" data-aos="fade-up">
          Start Inversting
        </button>
